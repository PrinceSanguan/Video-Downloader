...
export default function Welcome() {
    ...
    useEffect(() => {
        const fetchStarCount = async () => {
            try {
                const response = await fetch('https://api.github.com/repos/PrinceSanguan/Video-Downloader');
        ...
        <>
            ...
            <div className="relative flex h-[100vh] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-black">
                ...
                <div className="absolute top-4 right-4 sm:top-6 sm:right-6">
                    <a
                        href="https://github.com/PrinceSanguan/Video-Downloader"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 rounded-full border border-neutral-600/50 bg-neutral-800/80 px-3 py-2 text-sm font-medium text-white backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:bg-neutral-700/80"
                    >
